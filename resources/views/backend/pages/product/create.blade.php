                                    ...
                                    <div class="col-lg-8">
                                        <div class="form-row">
                                            <div class="form-group mb-4 col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="product_name" value="{{ old('product_name') }}" id="proname">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group mb-4 col-md-12">
                                                ...
                                                <textarea name="product_desc" class="summernote">{{ old('product_desc') }}</textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group mb-4 col-md-12">
                                                ...
                                                <textarea class="form-control" name="short_desc" rows="4" id="short_desc">{{ old('short_desc') }}</textarea>
                                    ...
                                    <div class="col-lg-4">
                                            ...
                                            <div class="input-group mb-4 col-md-12">
                                                ...
                                                <select class="form-control" name="subcategory_id" id="subcat">
                                                    ...
                                                    @foreach ($subcategory as $subcate)
                                                        <option value="{{ $subcate->id }}" {{ (old('subcategory_id') == $subcate->id) ? 'selected' : NULL }}>
                                                            {{ $subcate->subcat_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group mb-4 col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="product_brand" value="{{ old('product_brand') }}" id="brand">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group mb-4 col-md-12">
                                                ...
                                                <input type="number" class="form-control" name="product_price" value="{{ old('product_price') }}" id="price">
                                        ...
                                        <div class="form-row">
                                            <label for="prothumb" class="ml-2"> Thumbnails</label>
                                            <div class="input-group mb-4 col-md-12">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Upload</span>
                                                </div>
