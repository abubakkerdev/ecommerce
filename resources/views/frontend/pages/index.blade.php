...
@section('frontendBodyContent')
    <main>
                                    ...
                                    <div class="row">
                                        <div class="col col-lg-6">
                                            <div class="product_details_image p-0">
                                                <img src="{{ asset('backend/uploads/product/preview/'.$product->product_preview) }}" alt>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product_details_content">
                                                ...
                                                <div class="quantity_wrap">
                                                    ...
                                                    <div class="total_price">
                                                        Total: ${{ ($product->discount) ? $product->after_discount : $product->product_price }}
                                                    </div>
                                                </div>
                                ...
                                @foreach ($products as $product)
                                    <div class="grid col-lg-4">
                                        ...
                                        <div class="details">
                                            ...
                                            <p><a href="{{ route('product.index', $product->id) }}">{{ $product->short_desc }} </a></p>
                                            <div class="rating">
                                        ...
                                        <div class="category_boxed">
                                            <a href="{{ $category->id }}">
                                                <span class="item_image">
                                                    <img src="{{ asset('backend/uploads/category/'.$category->category_image ) }}" alt="image_not_found">
                                                </span>
                                                <span class="item_title">{{ $category->cat_name }}</span>
                                            </a>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="col col-lg-7">
                        <div class="new-arrivals-grids clearfix">
                            @foreach ($new_arrivals as $arrival)
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('backend/uploads/product/preview/'.$arrival->product_preview) }}" alt>

                                        @if (!empty($arrival->discount))
                                            <span class="theme-badge-2">{{ $arrival->discount }}% off</span>
                                        @else
                                            {{-- <span class="theme-badge">Sale</span> --}}
                                        @endif
                                        ...
                                        <div class="actions">
                                            <ul>
                                                ...
                                                <li>
                                                    <a class="quickview_btn" data-bs-toggle="modal" href="#arrival_popup{{ $arrival->id }}"
                                                        role="button" tabindex="0"><svg width="48px" height="48px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Visible (eye)</title> <path d="M22 12C22 12 19 18 12 18C5 18 2 12 2 12C2 12 5 6 12 6C19 6 22 12 22 12Z"/> <circle cx="12" cy="12" r="3"/> </svg></a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="details">
                                        <h4><a href="{{ route('product.index', $arrival->id) }}">{{ $arrival->product_name }}</a></h4>
                                        <p><a href="{{ route('product.index', $arrival->id) }}">{{ $arrival->short_desc }}</a></p>
                                        <span class="price">
                                            @if (!empty($arrival->discount))
                                                <ins>
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">$</span>{{ $arrival->after_discount }}
                                                        </bdi>
                                                    </span>
                                                </ins>
                                                <del aria-hidden="true">
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">$</span>{{ $arrival->product_price }}
                                                        </bdi>
                                                    </span>
                                                </del>
                                            @else
        ...
        @foreach ($new_arrivals as $arrival)
            <div class="modal fade" id="arrival_popup{{ $arrival->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalToggleLabel2">Product Quick View</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="product_details_content">
                                                ...
                                                <div class="item_price">
                                                    @if (!empty($arrival->discount))
                                                        <span>${{ $arrival->after_discount }}</span>
                                                        <del>${{ $arrival->product_price }}</del>
                                                    @else
                                                        <span>${{ $arrival->product_price }}</span>
                                                    @endif
                                                </div>
                                                <hr>
                                                <div class="item_attribute">
                                                ...
                                                <div class="quantity_wrap">
                                                    ...
                                                    <div class="total_price">
                                                        Total: ${{ ($arrival->discount) ? $arrival->after_discount : $arrival->product_price }}
                                                    </div>
                                                </div>
